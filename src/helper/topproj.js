...
const projectsTop = [
  ...
  },
  {
    ...
    The home page showcases a selection of stocks from the Stock Market Exchange, each represented by its symbol (e.g., AAPLE for APPLE Inc.).
