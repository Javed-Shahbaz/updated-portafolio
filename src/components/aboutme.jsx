        ...
        <div className="card-about">
          ...
          <div className="right">
            ...
            <p className="paragraph-about">
              I am a software developer with a strong background in teaching
              computer science. My unique blend of expertise allows me to
              approach challenges with a holistic perspective.
              <br />
              <br />
              With a genuine passion for technology and innovation, I am eager
              to contribute my skills and knowledge to your project.
              <br />
              <br />I am confident that I can provide valuable insights and help
              in creating solutions. Let's work together to drive meaningful
