...
const ProjectInfo = () => {
  ...
  useEffect(() => {
    const selectedProject = projectsTop.find(
        ...
        >
            ...
            <SwiperSlide>
              <div className="image-stack_item">
                <img
                  ...
                  src={projectData.imageProjectItem1}
                  alt="img"
                />
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className="image-stack_item">
                <img
                  ...
                  src={projectData.imageProjectItem2}
                  alt="img"
                />
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className="image-stack_item">
                <img
                  ...
                  src={projectData.imageProjectItem3}
                  alt="img"
                />
              </div>
            </SwiperSlide>
          ...
          {projectData.imageProjectItem4 && (
            <SwiperSlide>
              <div className="image-stack_item">
                <img
                  className="project-img-4"
                  src={projectData.imageProjectItem4}
                  alt="img"
                />
              </div>
            </SwiperSlide>
